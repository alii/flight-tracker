		...
		<div className="mx-4">
			<main className="max-w-4xl mx-auto my-16 space-y-8 shadow-xl shadow-gray-900/5 dark:shadow-gray-100/5 border p-6 rounded-lg border-gray-200/50 bg-gray-200/20 dark:border-gray-500/20 dark:bg-gray-600/20 backdrop-blur-lg">
				<div className="border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
					<div className="w-full h-6 relative bg-gray-50 dark:bg-gray-800">
						<div
							style={{width: `${flight.completedPercent}%`}}
							className="h-6 top-0 left-0 bottom-0 bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400 flex items-center justify-end pr-2 rounded-r-xl"
						>
				...
				<div className="space-y-2">
					<div className="flex items-center space-x-2">
						...
						<div className="mt-2">
							<span className="animate-pulse bg-red-500 text-red-900 font-bold tracking-wide uppercase px-2 rounded-full">
								Live
							</span>
						</div>
					</div>
					...
					<p className="text-gray-500 dark:text-gray-400">
						...
						<span className="text-gray-700 dark:text-gray-300">{flight.departure.airport.code}</span> to{' '}
				...
				<div className="grid grid-cols-3 gap-4">
					...
					<Card title="Departed From">{flight.departure.airport.code}</Card>
